...
const Dashboard = ({ history }) => {
    ...
    const btnMedicalHistory = () => {
        setOptionSidenav(2);
    }
    const btnMedicalAppoHist = () => {
        setOptionSidenav(3);
    }
            ...
            <div className="nav-fixed">
                ...
                <div id="layoutSidenav">
                                ...
                                <div className="sidenav-collapse-arrow"><svg className="svg-inline--fa fa-angle-down fa-w-10" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M143 352.3L7 216.3c-9.4-9.4-9.4-24.6 0-33.9l22.6-22.6c9.4-9.4 24.6-9.4 33.9 0l96.4 96.4 96.4-96.4c9.4-9.4 24.6-9.4 33.9 0l22.6 22.6c9.4 9.4 9.4 24.6 0 33.9l-136 136c-9.2 9.4-24.4 9.4-33.8 0z"></path></svg></div>
                                    ...
                                    <div className="collapse show" id="collapseDashboards" data-parent="#accordionSidenav">
                                        <nav className="sidenav-menu-nested nav accordion" id="accordionSidenavPages">
                                            <a className={optionSidenav === 1 ? "nav-link active" : "nav-link"} href="javascript:void(0);" onClick={() => {btnProfile()}}>
                                                Perfil
                                </a>
                                            <a className={optionSidenav === 2 ? "nav-link active" : "nav-link"} href="javascript:void(0);" onClick={() => {btnMedicalHistory()}}>
                                ...
                                <div className="sidenav-collapse-arrow"><svg className="svg-inline--fa fa-angle-down fa-w-10" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="angle-down" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" data-fa-i2svg=""><path fill="currentColor" d="M143 352.3L7 216.3c-9.4-9.4-9.4-24.6 0-33.9l22.6-22.6c9.4-9.4 24.6-9.4 33.9 0l96.4 96.4 96.4-96.4c9.4-9.4 24.6-9.4 33.9 0l22.6 22.6c9.4 9.4 9.4 24.6 0 33.9l-136 136c-9.2 9.4-24.4 9.4-33.8 0z"></path></svg></div>
                                    ...
                                    <div className="collapse" id="collapsePages" data-parent="#accordionSidenav">
                                        <nav className="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                                            <a className="nav-link" href="javascript:void(0);" className={optionSidenav === 3 ? "nav-link active" : "nav-link"} onClick={()=>{btnMedicalAppoHist()}} >
                                                Historial
                                </a>
                    ...
                    <div id="layoutSidenav_content">
                        {
                            optionSidenav === 1 ? (<Profile user={user} patient={patient} optionSidenav={optionSidenav} btnProfile={btnProfile} btnMedicalHistory={btnMedicalHistory}></Profile>) : (<></>)
                        }
                        {
                            optionSidenav === 2 ? (<MedicalHistory optionSidenav={optionSidenav} btnProfile={btnProfile} btnMedicalHistory={btnMedicalHistory}></MedicalHistory>) : (<></>)
                        }
                        {
                            optionSidenav === 3 ? (<MedicalAppoHist optionSidenav={optionSidenav} btnProfile={btnProfile} btnMedicalHistory={btnMedicalHistory}></MedicalAppoHist>) : (<></>)
                        }
                    </div>
                </div>
            </div>
