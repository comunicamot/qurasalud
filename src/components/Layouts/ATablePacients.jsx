...
const ATablePacients = ({ mostrarEspecialidades, specialities, eliminarEspecialidad, loading, history }) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ATablePacients);