...
export const MOSTRAR_DOCTORTURNS = 'MOSTRAR_DOCTORTURNS';
export const ELIMINAR_DOCTORTURN = 'ELIMINAR_DOCTORTURN';
export const ERROR_DOCTORTURN = 'ERROR_DOCTORTURN';
export const LOADING_DOCTORTURN = 'LOADING_DOCTORTURN';
...
export const ERROR_CITAS = 'ERROR_CITAS';
